...
"SELECT projects.title, (pledges.amount - projects.funding_goal) FROM projects WHERE (pledges.amount > projects.funding_goal) AND projects.id = pledges.project_id"
end
